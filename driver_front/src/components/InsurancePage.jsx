    ...
    return (
        <div className="min-h-full bg-[#F8FAFC] text-slate-800 font-sans">
            ...
            <main className="grid grid-cols-1 gap-4 px-4 pb-4">
                <section className="bg-slate-900 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden mt-6 max-w-[98%] mx-auto">
                ...
                <section className="bg-white rounded-2xl p-6 shadow-xl border-4 border-white overflow-hidden max-w-[98%] mx-auto">
                ...
                <div className="relative aspect-[16/9] bg-white rounded-2xl overflow-hidden shadow-xl border-4 border-white max-w-[98%] mx-auto">
                    {chartData.length > 0 ? (
